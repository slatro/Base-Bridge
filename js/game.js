...
const SHOP_DB = [
  ...
  { id: 'demon', type: 'skin', name: 'Demon', rarity: 'Epic', cost: 450, icon: 'demon', desc: 'A fiery fiend from the underworld.', colors: { body: '#ef4444', head: '#ef4444' } },
  ...
  { id: 'mini', type: 'skin', name: 'Mini', rarity: 'Legendary', cost: 550, icon: 'mini', desc: 'A small, yellow, pill-shaped fellow.', colors: { body: '#facc15', head: '#facc15', overalls: '#1e3a8a', height: 75 } },
