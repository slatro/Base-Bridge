...
const AVATAR_LIST = [
  ...
  { id: 'wizard', svg: `data:image/svg+xml;utf8,<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><circle cx="50" cy="50" r="45" fill="%231e40af"/><path d="M20,50 Q50,100 80,50 Z" fill="white"/><path d="M15,45 L85,45 L50,5 Z" fill="%231e40af"/><circle cx="55" cy="40" r="5" fill="%23ffedd5"/><circle cx="58" cy="40" r="2" fill="black"/></svg>` },
