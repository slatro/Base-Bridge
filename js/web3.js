...
const AVATAR_LIST = [
  ...
  { id: 'ninja', svg: `data:image/svg+xml;utf8,<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><circle cx="50" cy="50" r="45" fill="%23111"/><rect x="30" y="45" width="40" height="20" rx="5" fill="%23ffbda1"/><circle cx="42" cy="55" r="4" fill="%23111"/><circle cx="58" cy="55" r="4" fill="%23111"/><rect x="15" y="30" width="70" height="20" rx="8" fill="%23ff0000"/></svg>` },
