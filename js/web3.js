...
const AVATAR_LIST = [
  { id: 'classic', svg: `data:image/svg+xml;utf8,<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="helmGrad" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="%231e293b"/><stop offset="100%" stop-color="%230f172a"/></linearGradient></defs><circle cx="50" cy="50" r="48" fill="url(%23helmGrad)" stroke="%23334155" stroke-width="2"/><path d="M 15 45 Q 50 35 85 45 L 80 65 Q 50 75 20 65 Z" fill="%230052FF" opacity="0.8"/><rect x="20" y="48" width="60" height="12" rx="4" fill="%2300e5ff" opacity="0.9"/><path d="M 25 50 L 75 50" stroke="%23fff" stroke-width="1" opacity="0.5"/><path d="M 15 45 L 20 65 M 85 45 L 80 65" stroke="%23334155" stroke-width="2"/><circle cx="50" cy="25" r="3" fill="%2300e5ff"/><path d="M 30 85 Q 50 95 70 85" fill="none" stroke="%23334155" stroke-width="4" stroke-linecap="round"/></svg>` },
