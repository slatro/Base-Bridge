...
const SVG_ICONS = {
  ...
  wpn_axe: `data:image/svg+xml;utf8,<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><rect x="46" y="20" width="8" height="75" rx="2" fill="%232b1604"/><path d="M54 25 Q90 25 90 48 Q90 70 54 70 L54 60 Q75 48 54 35 Z" fill="%23e2e8f0" stroke="%23475569" stroke-width="2"/><path d="M46 25 Q10 25 10 48 Q10 70 46 70 L46 60 Q25 48 46 35 Z" fill="%23e2e8f0" stroke="%23475569" stroke-width="2"/><rect x="43" y="30" width="14" height="6" fill="%2394a3b8"/></svg>`,
  wpn_gun: `data:image/svg+xml;utf8,<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><path d="M15 40 H75 L85 45 L85 55 L15 60 Z" fill="%231e293b" stroke="%230f172a" stroke-width="2"/><rect x="20" y="60" width="15" height="30" rx="4" fill="%230f172a"/><path d="M70 43 H95 V57 H70 Z" fill="%2300e5ff" opacity="0.6"/><circle cx="85" cy="50" r="6" fill="%23fff" filter="drop-shadow(0 0 10px %2300e5ff)"/><rect x="30" y="35" width="30" height="5" rx="2" fill="%23334155"/></svg>`
};
let loadedIcons = {};
