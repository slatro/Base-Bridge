...
const AVATAR_LIST = [
  ...
  { id: 'troop', svg: `data:image/svg+xml;utf8,<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><circle cx="50" cy="50" r="45" fill="%23e11d48"/><circle cx="50" cy="55" r="28" fill="%23111"/><circle cx="45" cy="50" r="3" fill="white" opacity="0.8"/><circle cx="60" cy="50" r="3" fill="white" opacity="0.8"/></svg>` },
