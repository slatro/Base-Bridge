...
const AVATAR_LIST = [
  { id: 'classic', svg: `data:image/svg+xml;utf8,<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="g1" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="%23334155"/><stop offset="100%" stop-color="%230f172a"/></linearGradient></defs><path d="M 20 20 L 80 20 L 90 50 L 80 85 L 20 85 L 10 50 Z" fill="url(%23g1)" stroke="%23475569" stroke-width="2"/><path d="M 25 40 L 75 40 L 80 55 L 50 65 L 20 55 Z" fill="%230052FF" opacity="0.9"/><path d="M 30 45 L 70 45 L 75 52 L 50 60 L 25 52 Z" fill="%2300e5ff" opacity="0.8"/><path d="M 10 50 L 90 50" stroke="%231e293b" stroke-width="1" opacity="0.3"/><circle cx="50" cy="15" r="4" fill="%230052FF"/><path d="M 40 85 L 60 85" stroke="%2300e5ff" stroke-width="3" stroke-linecap="round" opacity="0.6"/></svg>` },
