...
const SHOP_DB = [
  ...
  { id: 'ninja', type: 'skin', name: 'Ninja', rarity: 'Uncommon', cost: 250, icon: 'ninja', desc: 'A swift warrior of the night.', colors: { body: '#111111', head: '#111111', straps: '#1f2937' } },
  { id: 'cyber', type: 'skin', name: 'Based', rarity: 'Rare', cost: 300, icon: 'cyber', desc: 'Friendly AI robot from the future.', colors: { body: '#f8fafc', head: '#0052ff', glow: '#111111' } },
  { id: 'dino', type: 'skin', name: 'Dino', rarity: 'Epic', cost: 350, icon: 'dino', desc: 'A prehistoric powerhouse.', colors: { body: '#65a30d', head: '#65a30d' } },
  { id: 'wizard', type: 'skin', name: 'Wizard', rarity: 'Epic', cost: 400, icon: 'wizard', desc: 'A wise sorcerer with a star-patterned robe.', colors: { body: '#1d4ed8', head: '#ffffff', hat: '#1d4ed8', stars: '#facc15' } },
  { id: 'mini', type: 'skin', name: 'Mini', rarity: 'Epic', cost: 450, icon: 'mini', desc: 'A small, yellow, pill-shaped fellow.', colors: { body: '#facc15', head: '#facc15', overalls: '#1e3a8a', height: 75 } },
  { id: 'troop', type: 'skin', name: 'Troop', rarity: 'Legendary', cost: 500, icon: 'troop', desc: 'Shadowed face hidden beneath a red hood.', colors: { body: '#e11d48', head: '#be123c', faceShadow: '#111111' } },
  { id: 'demon', type: 'skin', name: 'Demon', rarity: 'Legendary', cost: 550, icon: 'demon', desc: 'A fiery fiend from the underworld.', colors: { body: '#ef4444', head: '#ef4444' } },
...
function renderSkeleton(targetCtx, skinId, hatId, capeId, wpnId, faceId, s, state, time) {
  ...
  if (id === 'troop') {
    ...
    targetCtx.fillStyle = '#ffffff';
    targetCtx.beginPath();
    targetCtx.moveTo(s*0.07, s*0.2); 
    targetCtx.lineTo(s*0.23, s*0.16); 
    targetCtx.lineTo(s*0.23, s*0.21); 
    targetCtx.lineTo(s*0.15, s*0.23); 
    targetCtx.fill();
