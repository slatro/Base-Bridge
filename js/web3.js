...
const AVATAR_LIST = [
  ...
  { id: 'demon', svg: `data:image/svg+xml;utf8,<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="demonBg" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="%23ef4444"/><stop offset="100%" stop-color="%23991b1b"/></linearGradient></defs><rect x="25" y="25" width="50" height="75" rx="25" fill="url(%23demonBg)"/><path d="M 35 30 L 25 10 L 45 25 Z" fill="%231f2937"/><path d="M 65 30 L 75 10 L 55 25 Z" fill="%231f2937"/><path d="M 30 45 L 45 50" stroke="%23111" stroke-width="4" stroke-linecap="round"/><path d="M 70 45 L 55 50" stroke="%23111" stroke-width="4" stroke-linecap="round"/><circle cx="40" cy="55" r="6" fill="%23fff"/><circle cx="40" cy="55" r="3" fill="%23b91c1c"/><circle cx="60" cy="55" r="6" fill="%23fff"/><circle cx="60" cy="55" r="3" fill="%23b91c1c"/><path d="M 35 70 Q 50 85 65 70 Q 50 80 35 70" fill="%23111"/><path d="M 38 72 L 43 78 L 48 72 L 53 78 L 58 72 L 63 76" stroke="%23fff" stroke-width="2" fill="none"/></svg>` },
