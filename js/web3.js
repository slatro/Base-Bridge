...
const AVATAR_LIST = [
  ...
  { id: 'ninja', svg: `data:image/svg+xml;utf8,<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><circle cx="50" cy="50" r="45" fill="%23111"/><rect x="5" y="32" width="90" height="20" rx="10" fill="red"/><rect x="30" y="50" width="40" height="15" rx="6" fill="%23ffedd5"/><circle cx="43" cy="57" r="3.5" fill="black"/><circle cx="57" cy="57" r="3.5" fill="black"/></svg>` },
  { id: 'cyber', svg: `data:image/svg+xml;utf8,<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><defs><radialGradient id="rbg" cx="50%" cy="50%" r="50%"><stop offset="0%" stop-color="%23fff"/><stop offset="100%" stop-color="%23e2e8f0"/></radialGradient></defs><rect x="35" y="0" width="30" height="15" rx="5" fill="%236366f1"/><rect x="0" y="35" width="15" height="30" rx="5" fill="%236366f1"/><rect x="85" y="35" width="15" height="30" rx="5" fill="%236366f1"/><rect x="10" y="10" width="80" height="80" rx="25" fill="url(%23rbg)" stroke="%23cbd5e1" stroke-width="2"/><rect x="20" y="25" width="60" height="50" rx="15" fill="%231e293b"/><circle cx="35" cy="45" r="6" fill="%2300e5ff"/><circle cx="65" cy="45" r="6" fill="%2300e5ff"/><path d="M 38 65 Q 50 75 62 65" fill="none" stroke="%2300e5ff" stroke-width="4" stroke-linecap="round"/></svg>` },
  ...
  { id: 'troop', svg: `data:image/svg+xml;utf8,<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="redGrad" x1="0%" y1="0%" x2="0%" y2="100%"><stop offset="0%" stop-color="%23ef4444"/><stop offset="100%" stop-color="%23991b1b"/></linearGradient></defs><circle cx="50" cy="50" r="45" fill="url(%23redGrad)"/><path d="M 20 70 L 50 95 L 80 70 Z" fill="%23991b1b"/><path d="M 5 42 Q 50 30 95 42 L 85 55 Q 50 45 15 55 Z" fill="%23111"/><path d="M 20 55 L 80 55 L 70 85 L 30 85 Z" fill="%23111"/><path d="M 5 55 L 42 88 L 30 90 Z" fill="%23ef4444"/><path d="M 95 55 L 58 88 L 70 90 Z" fill="%23ef4444"/><path d="M 40 48 L 60 48 L 65 80 L 50 92 L 35 80 Z" fill="url(%23redGrad)"/></svg>` },
