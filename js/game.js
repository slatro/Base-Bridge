...
const SVG_ICONS = {
  ...
  wpn_axe: `data:image/svg+xml;utf8,<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><rect x="46" y="20" width="8" height="70" rx="4" fill="%23451a03"/><path d="M50 25 L80 10 L85 45 L50 50 Z" fill="%23cbd5e1" stroke="%23475569" stroke-width="2"/><path d="M50 25 L20 10 L15 45 L50 50 Z" fill="%23cbd5e1" stroke="%23475569" stroke-width="2"/><rect x="42" y="28" width="16" height="8" rx="2" fill="%23ca8a04"/></svg>`,
  wpn_gun: `data:image/svg+xml;utf8,<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><path d="M20 40 L75 40 L85 45 L85 55 L20 60 Z" fill="%23334155" stroke="%230f172a" stroke-width="2"/><rect x="25" y="55" width="12" height="30" rx="3" fill="%231e293b"/><path d="M70 42 L90 42 L90 53 L70 53 Z" fill="%2300e5ff" opacity="0.5"/><circle cx="80" cy="47" r="5" fill="%23fff" filter="drop-shadow(0 0 8px %2300e5ff)"/><rect x="35" y="35" width="25" height="5" rx="2" fill="%23475569"/></svg>`
};
let loadedIcons = {};
