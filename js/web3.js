...
const AVATAR_LIST = [
  { id: 'classic', svg: `data:image/svg+xml;utf8,<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><circle cx="50" cy="50" r="45" fill="%23111"/><circle cx="40" cy="40" r="5" fill="%23fff"/></svg>` },
  { id: 'ninja', svg: `data:image/svg+xml;utf8,<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><circle cx="50" cy="50" r="48" fill="%23111"/><rect x="2" y="32" width="96" height="20" rx="10" fill="red"/><rect x="30" y="50" width="40" height="15" rx="6" fill="%23ffedd5"/><circle cx="43" cy="57" r="3.5" fill="black"/><circle cx="57" cy="57" r="3.5" fill="black"/></svg>` },
  { id: 'cyber', svg: `data:image/svg+xml;utf8,<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><defs><radialGradient id="rbg" cx="50%" cy="50%" r="50%"><stop offset="0%" stop-color="%23fff"/><stop offset="100%" stop-color="%23e2e8f0"/></radialGradient></defs><rect x="15" y="20" width="70" height="60" rx="20" fill="url(%23rbg)" stroke="%23cbd5e1" stroke-width="2"/><rect x="5" y="40" width="10" height="20" rx="5" fill="%236366f1"/><rect x="85" y="40" width="10" height="20" rx="5" fill="%236366f1"/><rect x="40" y="10" width="20" height="10" rx="5" fill="%236366f1"/><rect x="25" y="30" width="50" height="40" rx="15" fill="%231e293b"/><circle cx="40" cy="45" r="5" fill="%2300e5ff"/><circle cx="60" cy="45" r="5" fill="%2300e5ff"/><path d="M40,60 Q50,68 60,60" fill="none" stroke="%2300e5ff" stroke-width="3" stroke-linecap="round"/></svg>` },
  { id: 'wizard', svg: `data:image/svg+xml;utf8,<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><circle cx="50" cy="65" r="22" fill="%23ffedd5"/><path d="M 30,65 Q 50,110 70,65 Z" fill="%23fff"/><circle cx="40" cy="60" r="3.5" fill="%23111"/><circle cx="60" cy="60" r="3.5" fill="%23111"/><path d="M 34,53 Q 40,49 46,53" fill="none" stroke="%23fff" stroke-width="3" stroke-linecap="round"/><path d="M 54,53 Q 60,49 66,53" fill="none" stroke="%23fff" stroke-width="3" stroke-linecap="round"/><path d="M 28,45 L 50,5 L 72,45 Z" fill="%231e40af"/><ellipse cx="50" cy="45" rx="40" ry="7" fill="%231e40af"/><path d="M 30,42 Q 50,48 70,42 L 67,36 Q 50,42 33,36 Z" fill="%23fff"/><path d="M 50,73 Q 35,67 18,80 Q 35,77 50,73 Z" fill="%23fff"/><path d="M 50,73 Q 65,67 82,80 Q 65,77 50,73 Z" fill="%23fff"/><circle cx="50" cy="69" r="5" fill="%23fbcfe8"/><path d="M 55,28 A 6 6 0 1 0 55,16 A 8 8 0 1 1 55,28 Z" fill="%23facc15"/><circle cx="35" cy="25" r="1.5" fill="%23fff"/><circle cx="45" cy="14" r="1.5" fill="%23fff"/><circle cx="65" cy="28" r="1.5" fill="%23fff"/></svg>` },
  { id: 'troop', svg: `data:image/svg+xml;utf8,<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="redGrad" x1="0%" y1="0%" x2="0%" y2="100%"><stop offset="0%" stop-color="%23ef4444"/><stop offset="100%" stop-color="%23991b1b"/></linearGradient></defs><circle cx="50" cy="50" r="46" fill="url(%23redGrad)"/><path d="M 20,70 L 50,98 L 80,70 Z" fill="%23991b1b"/><path d="M 5,42 Q 50,30 95,42 L 85,55 Q 50,45 15,55 Z" fill="%23111"/><path d="M 20,55 L 80,55 L 70,85 L 30,85 Z" fill="%23111"/><path d="M 5,55 L 42,88 L 30,90 Z" fill="%23ef4444"/><path d="M 95,55 L 58,88 L 70,90 Z" fill="%23ef4444"/><path d="M 40,48 L 60,48 L 65,80 L 50,92 L 35,80 Z" fill="url(%23redGrad)"/></svg>` },
  { id: 'galaxy', svg: `data:image/svg+xml;utf8,<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><circle cx="50" cy="50" r="45" fill="%23a855f7"/><path d="M10,20 L90,20 L90,35 L10,35 Z" fill="%23eab308"/><circle cx="60" cy="55" r="6" fill="black"/><path d="M30,70 L70,70" stroke="black" stroke-width="2" opacity="0.3"/></svg>` }
];
