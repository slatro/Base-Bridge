...
const AVATAR_LIST = [
  { id: 'classic', svg: `data:image/svg+xml;utf8,<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><rect x="0" y="0" width="100" height="100" fill="%23fff"/><path d="M 20 100 L 25 65 Q 50 60 75 65 L 80 100 Z" fill="%23334155" stroke="%23111" stroke-width="2"/><path d="M 30 100 L 30 80 L 70 80 L 70 100" fill="none" stroke="%23111" stroke-width="2"/><circle cx="50" cy="40" r="22" fill="%23fed7aa" stroke="%23111" stroke-width="2"/><path d="M 25 35 Q 50 45 75 35 Q 75 48 50 50 Q 25 48 25 35 Z" fill="%23111"/><circle cx="40" cy="41" r="5" fill="%23fff"/><circle cx="42" cy="41" r="2" fill="%23111"/><circle cx="60" cy="41" r="5" fill="%23fff"/><circle cx="58" cy="41" r="2" fill="%23111"/><path d="M 25 30 Q 50 -5 75 30 Z" fill="%23111"/><path d="M 22 28 L 78 28 L 76 33 L 24 33 Z" fill="%23111"/><path d="M 40 52 Q 50 62 60 52 Z" fill="%23ef4444" stroke="%23111" stroke-width="2"/></svg>` },
