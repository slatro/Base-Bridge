...
const AVATAR_LIST = [
  ...
  { id: 'cyber', svg: `data:image/svg+xml;utf8,<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><defs><radialGradient id="cg" cx="40%" cy="40%" r="50%"><stop offset="0%" stop-color="%23fff"/><stop offset="100%" stop-color="%23cbd5e1"/></radialGradient></defs><circle cx="50" cy="50" r="45" fill="url(%23cg)"/><ellipse cx="65" cy="50" rx="25" ry="18" fill="%230f172a"/><circle cx="70" cy="50" r="8" fill="%2300e5ff"/><circle cx="72" cy="48" r="2" fill="white"/></svg>` },
