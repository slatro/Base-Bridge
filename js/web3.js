...
const AVATAR_LIST = [
  { id: 'classic', svg: `data:image/svg+xml;utf8,<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><rect x="0" y="0" width="100" height="100" fill="%23fff"/><path d="M 20 50 C 15 10 85 10 80 50 L 75 80 Q 50 100 25 80 Z" fill="%23333"/><path d="M 15 45 Q 50 25 85 45" fill="none" stroke="%23fff" stroke-width="2"/><path d="M 20 52 Q 50 45 80 52 L 75 65 Q 50 72 25 65 Z" fill="%23333" stroke="%23fff" stroke-width="2"/><path d="M 30 55 Q 38 48 45 55 Z" fill="%23fff"/><path d="M 55 55 Q 62 48 70 55 Z" fill="%23fff"/></svg>` },
