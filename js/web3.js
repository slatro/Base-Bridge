...
const AVATAR_LIST = [
  ...
  { id: 'wizard', svg: `data:image/svg+xml;utf8,<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><path d="M50 5 L85 85 L15 85 Z" fill="%231e3a8a"/><path d="M50 15 Q65 15 70 25 Q75 35 65 35 Q55 35 50 25 Z" fill="%23fff"/><circle cx="40" cy="40" r="3" fill="%23fff"/><circle cx="60" cy="40" r="3" fill="%23fff"/><path d="M30 90 Q50 60 70 90" fill="%23fff"/><circle cx="50" cy="50" r="20" fill="%23ffedd5"/><path d="M40 50 Q50 60 60 50" stroke="%23333" fill="none" stroke-width="2"/><ellipse cx="40" cy="45" rx="3" ry="5" fill="black"/><ellipse cx="60" cy="45" rx="3" ry="5" fill="black"/></svg>` },
