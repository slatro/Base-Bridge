...
const AVATAR_LIST = [
  { id: 'classic', svg: `data:image/svg+xml;utf8,<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="skinG" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="%23ffedd5"/><stop offset="100%" stop-color="%23fdba74"/></linearGradient></defs><path d="M 20 85 Q 50 105, 80 85 L 80 100 L 20 100 Z" fill="%23111"/><path d="M 30 50 Q 30 20, 50 20 Q 70 20, 70 50 L 70 80 Q 50 90, 30 80 Z" fill="url(%23skinG)" stroke="%23111" stroke-width="2"/><path d="M 20 40 L 80 40 L 80 45 L 20 45 Z" fill="%23111"/><path d="M 30 40 L 30 20 L 70 20 L 70 40 Z" fill="%23111"/><rect x="35" y="48" width="12" height="8" rx="2" fill="%23111"/><rect x="53" y="48" width="12" height="8" rx="2" fill="%23111"/><path d="M 47 52 L 53 52" stroke="%23111" stroke-width="1.5"/><path d="M 45 70 L 60 70" stroke="%23111" stroke-width="2" stroke-linecap="round"/><path d="M 60 70 Q 75 70, 75 60" fill="none" stroke="%2378350f" stroke-width="3"/><rect x="72" y="55" width="6" height="4" fill="%2378350f"/></svg>` },
