...
const AVATAR_LIST = [
  ...
  { id: 'cyber', svg: `data:image/svg+xml;utf8,<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><defs><radialGradient id="astroBg" cx="50%" cy="50%" r="50%"><stop offset="0%" stop-color="%23ffffff"/><stop offset="100%" stop-color="%23cbd5e1"/></radialGradient></defs><rect x="35" y="55" width="30" height="35" rx="15" fill="url(%23astroBg)" stroke="%2394a3b8" stroke-width="2"/><path d="M 38 60 Q 50 80 62 60" fill="%230078ff"/><path d="M 50 15 L 50 5" stroke="%23cbd5e1" stroke-width="3"/><circle cx="50" cy="5" r="4" fill="%2300e5ff"/><rect x="15" y="15" width="70" height="45" rx="20" fill="url(%23astroBg)" stroke="%2394a3b8" stroke-width="2"/><rect x="20" y="20" width="60" height="35" rx="15" fill="%23000"/><ellipse cx="35" cy="40" rx="8" ry="12" fill="%2300e5ff"/><circle cx="37" cy="35" r="3" fill="%23fff"/><ellipse cx="65" cy="40" rx="8" ry="12" fill="%2300e5ff"/><circle cx="67" cy="35" r="3" fill="%23fff"/></svg>` },
  ...
  { id: 'sparky', svg: `data:image/svg+xml;utf8,<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><rect x="10" y="10" width="80" height="80" rx="15" fill="%23fcd34d"/><path d="M 25 35 L 15 15 L 35 25 Z" fill="%23facc15"/><path d="M 15 15 L 22 23 L 28 18 Z" fill="%23111"/><path d="M 75 35 L 85 15 L 65 25 Z" fill="%23facc15"/><path d="M 85 15 L 78 23 L 72 18 Z" fill="%23111"/><circle cx="50" cy="55" r="30" fill="%23facc15"/><circle cx="30" cy="65" r="8" fill="%23ef4444"/><circle cx="70" cy="65" r="8" fill="%23ef4444"/><circle cx="40" cy="50" r="4" fill="%23111"/><circle cx="60" cy="50" r="4" fill="%23111"/><circle cx="39" cy="48" r="1.5" fill="%23fff"/><circle cx="59" cy="48" r="1.5" fill="%23fff"/><path d="M 45 58 Q 50 62 55 58" fill="none" stroke="%23111" stroke-width="2" stroke-linecap="round"/></svg>` }
];
