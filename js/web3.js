...
const AVATAR_LIST = [
  ...
  { id: 'ninja', svg: `data:image/svg+xml;utf8,<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><circle cx="50" cy="50" r="45" fill="%23111"/><rect x="5" y="15" width="90" height="15" fill="%23ef4444"/><rect x="30" y="35" width="40" height="20" rx="5" fill="%23ffedd5"/><circle cx="55" cy="45" r="6" fill="black"/></svg>` },
  { id: 'cyber', svg: `data:image/svg+xml;utf8,<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><circle cx="50" cy="50" r="45" fill="%23f8fafc"/><ellipse cx="60" cy="50" rx="25" ry="20" fill="%230f172a"/><circle cx="65" cy="50" r="8" fill="%2300e5ff"/></svg>` },
  { id: 'wizard', svg: `data:image/svg+xml;utf8,<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><path d="M10,40 L90,40 L50,5 Z" fill="%231e40af"/><circle cx="50" cy="50" r="25" fill="%23ffedd5"/><path d="M25,50 Q50,90 75,50 Z" fill="white"/><circle cx="55" cy="50" r="5" fill="black"/></svg>` },
  { id: 'hoodie', svg: `data:image/svg+xml;utf8,<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><circle cx="50" cy="50" r="45" fill="%23e11d48"/><circle cx="65" cy="58" r="22" fill="%23111"/></svg>` },
  { id: 'galaxy', svg: `data:image/svg+xml;utf8,<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><circle cx="50" cy="50" r="45" fill="%23a855f7"/><rect x="20" y="10" width="60" height="12" fill="%23eab308"/><circle cx="60" cy="45" r="7" fill="black"/></svg>` }
];
