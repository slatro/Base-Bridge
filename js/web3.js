...
const AVATAR_LIST = [
  { id: 'classic', svg: `data:image/svg+xml;utf8,<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="skinG" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="%23ffedd5"/><stop offset="100%" stop-color="%23fdba74"/></linearGradient></defs><path d="M 20 85 Q 50 105, 80 85 L 80 100 L 20 100 Z" fill="%23111"/><path d="M 30 50 Q 30 20, 50 20 Q 70 20, 70 50 L 70 75 Q 50 85, 30 75 Z" fill="url(%23skinG)" stroke="%23111" stroke-width="2"/><path d="M 30 45 Q 30 15, 50 15 Q 70 15, 70 45 Z" fill="%23111"/><rect x="10" y="35" width="30" height="8" rx="2" fill="%23111"/><circle cx="42" cy="50" r="3" fill="%23111"/><circle cx="62" cy="50" r="3" fill="%23111"/><path d="M 48 65 Q 58 68, 65 62" fill="none" stroke="%23111" stroke-width="2.5" stroke-linecap="round"/><path d="M 70 45 C 85 45, 85 65, 70 65" fill="none" stroke="%23111" stroke-width="1.5" opacity="0.3"/></svg>` },
