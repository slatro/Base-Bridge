...
const AVATAR_LIST = [
  ...
  { id: 'ninja', svg: `data:image/svg+xml;utf8,<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><circle cx="50" cy="50" r="45" fill="%23111"/><path d="M5,35 L95,35 L95,50 L5,50 Z" fill="%23ef4444"/><rect x="30" y="50" width="40" height="18" rx="8" fill="%23ffedd5"/><circle cx="52" cy="58" r="4" fill="black"/></svg>` },
